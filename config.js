const config = {
  ...
  sidebar: {
    forcedNavOrder: ['01-v2.5.11','05-v3.0-Beta','06-v3.2','07-v3.2.9','30-v3.0.13','46-faq'],
    collapsedNav: [],
  ...
  siteMetadata: {
    ...
    ogImage: null,
    docsLocation: '',
    favicon: 'https://raw.githubusercontent.com/DigtLab-QA/CryptoGost/master/src/images/cryptogost.png',
  },
  pwa: {
