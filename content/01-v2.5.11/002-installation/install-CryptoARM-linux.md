...
### Установка через терминал
1. Для установки с помощью командной строки нужно запустить терминал и ввести команду:
**sudo rpm -i <путь\_к\_файлу/название_файла.rpm>**
...
## Установка КриптоАРМ ГОСТ на операционную систему РОСА 
### Графическая установка
1. На скачанный установочный файл нажать правой кнопкой мыши и выбрать **Открыть в Yumex Package Installer**.
   ![rosa-01.png](./images/rosa-01.png)
2. **Ввести** пароль системного администратора root и нажать **Аутентификация**. 
   ![rosa-02.png](./images/rosa-02.png)
3. Откроется окно **Installing local Packages**, в котором нужно нажать **Ок**. Начнётся установка.
    ![rosa-03.png](./images/rosa-03.png)
    ![rosa-04.png](./images/rosa-04.png)
4. Откроется окно **Yum Extender**, в котором нужно нажать **Ок**.
   ![rosa-05.png](./images/rosa-05.png)
5. После установки приложения в меню появится ярлык КриптоАРМ ГОСТ.
   ![rosa-06.png](./images/rosa-06.png)
...
*Указать путь к установочному файлу и его название вручную или перетащить его в поле терминала.*
![rosa-07.png](./images/rosa-07.png)
